...
Texture::Texture(IDirect3DDevice9 *device, unsigned width, unsigned height, unsigned samplers_count)
: device(device), texture(NULL), width(width), height(height), samplers_count(samplers_count)
{
